...
function TrialOfValor:OnEnable()
  ...
  self:RegisterRaidTier("Legion", 70010, trialOfValorName, PLAYER_DIFFICULTY1, PLAYER_DIFFICULTY2, PLAYER_DIFFICULTY6)
  self:RegisterRaidInstance(70010, ToV, trialOfValorName, {
    bonusids = {
      [1] = {3524},
      [2] = {3524},
      [3] = {3524},
  ...
  if self.LegionLegendaries then
    ...
    self:RegisterMiscItems(ToV, misc, 3571)
  end
end
