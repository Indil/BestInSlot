local LegionDungeons = LibStub("AceAddon-3.0"):GetAddon("BestInSlot"):NewModule("LegionDungeons")
...
function LegionDungeons:VioletHold()
  local VH = "VH"
...
function LegionDungeons:BlackRookHold()
  local BRH = "BRH"
...
function LegionDungeons:CourtOfStars()
  local CoS = "CoS"
...
function LegionDungeons:DarkheartThicket()
  local DT = "DT"
...
function LegionDungeons:EyeOfAzshara()
  local EoA = "EoA"
...
function LegionDungeons:HallsOfValor()
  local HoV = "HoV"
...
function LegionDungeons:MawOfSouls()
  local MoS = "MoS"
...
function LegionDungeons:NeltharionsLair()
  local NL = "NL"
...
function LegionDungeons:Arcway()
  local Arc = "Arc"
...
function LegionDungeons:VaultOfTheWardens()
  local VotW = "VotW"
...
function LegionDungeons:ReturnToKarazhan()
  local RtK = "RtK"
...
function LegionDungeons:CathedralofEternalNight()
  local CoEN = "CoEN"
...
function LegionDungeons:OnEnable()
  self:RegisterExpansion("Legion", EXPANSION_NAME6)
  self:RegisterRaidTier("Legion", dungeonTierId, ("%s %s"):format(DUNGEONS, EXPANSION_NAME6), PLAYER_DIFFICULTY1, PLAYER_DIFFICULTY2, PLAYER_DIFFICULTY6)
  ...
  if self.LegionLegendaries then --issue registering LOOT_JOURNAL_LEGENDARIES
    local misc = {
      LOOT_JOURNAL_LEGENDARIES = self.LegionLegendaries:GetList()
    }
	self:RegisterMiscItems(_, misc, 3571)
  end
end

function LegionDungeons:InitializeZoneDetect(ZoneDetect)
  local VH = "VH"
